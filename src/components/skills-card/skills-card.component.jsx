	...
	return (
		<>
			...
			<StackList>
				...
				<Item>
					I'm writing scripts in <Bash style={{ borderBottom: '3px solid #300a24' }}>user@ubuntu<Bash2>:~$<ReactRotatingText items={['']} /></Bash2></Bash> and <PsComponent style={{ borderBottom: '3px solid #012456' }}>PS C:\> <ReactRotatingText items={['']} /></PsComponent> based on the specific needs of the institutions I work with.
				</Item>
			</StackList>
		</>
	)
